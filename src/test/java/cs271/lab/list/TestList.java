...
public class TestList {
  ...
  public void testContains() {
    // TODO write assertions using [COMPLETE]
    // list.contains(77)
  ...
  public void testContainsAll() {
    ...
    list.add(77);
    list.add(66);
    // TODO using containsAll and List.of (see above), [COMPLETE]
  ...
  public void testAddAll() {
    // TODO in a single statement using addAll and List.of, [COMPLETE]
  ...
  public void testRemoveAll() {
    ...
    list.add(77);
    list.add(66);
    // TODO in a single statement using removeAll and List.of, [COMPLETE]
  ...
  public void testRetainAll() {
    ...
    list.add(77);
    list.add(66);
    // TODO in a single statement using retainAll and List.of, [COMPLETE]
    // remove items from the list to make the following assertions pass
    // (without touching the assertions themselves)
